...
class Subscription(Document):
    ...
    def process_for_past_due_canceled(self):
        if self.is_postpaid_to_invoice() and self.invoices_in_past_due_date:
            self.generate_invoice()
    ...
    def cancel_subscription_at_period_end(self):
        ...
        if self.status == 'Past Due Date':
            self.process_for_past_due_canceled()
